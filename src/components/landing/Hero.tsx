  ...
  return (
    <section className="relative h-screen flex items-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-background via-muted/5 to-primary/5">
        <div className="absolute inset-0 bg-[linear-linear(to_right,#f1f5f9_1px,transparent_1px),linear-linear(to_bottom,#f1f5f9_1px,transparent_1px)] bg-size-[4rem_4rem] mask-[radial-linear(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_110%)] opacity-20"></div>
      </div>
