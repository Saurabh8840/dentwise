...
function DoctorSelectionStep({
  ...
  const { data: dentists = [] } = useAvailableDoctors() as { data: Array<{ id: string; name: string; imageUrl?: string; speciality?: string; appointmentCount: number; phone: string; bio?: string }> };
  const { isLoading } = useAvailableDoctors();
